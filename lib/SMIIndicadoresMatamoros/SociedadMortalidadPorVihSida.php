<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadMortalidadPorVihSida
 *
...
class SociedadMortalidadPorVihSida extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad por VIH-SIDA en Matamoros';
        ...
        $this->claves      = 'IMPLAN, Matamoros, Salud, Bienestar, Grupos Vulnerables, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '1.8000', 'fuente_nombre' => 'SINAIS (SSA)', 'notas' => ''));
    } // datos
