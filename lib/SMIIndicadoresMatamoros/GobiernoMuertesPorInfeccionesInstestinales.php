<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros GobiernoMuertesPorInfeccionesInstestinales
 *
...
class GobiernoMuertesPorInfeccionesInstestinales extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Muertes por Infecciones Instestinales en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '3.7479', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '0.9296', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '2.7671', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '0.9152', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '3.6283', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
