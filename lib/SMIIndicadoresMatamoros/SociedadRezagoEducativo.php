<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadRezagoEducativo
 *
...
Tiene 16 años o más, nació a partir de 1982 y no cuenta con el nivel de educación obligatoria. CONEVAL';
        $this->claves      = 'IMPLAN, Matamoros, Educación, Grupos Vulnerables, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '19.2000', 'fuente_nombre' => 'CONEVAL', 'notas' => ''));
    } // datos
