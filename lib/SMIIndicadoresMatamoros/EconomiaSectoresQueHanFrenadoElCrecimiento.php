<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros EconomiaSectoresQueHanFrenadoElCrecimiento
 *
...
class EconomiaSectoresQueHanFrenadoElCrecimiento extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Sectores que Han Frenado el Crecimiento en Matamoros';
