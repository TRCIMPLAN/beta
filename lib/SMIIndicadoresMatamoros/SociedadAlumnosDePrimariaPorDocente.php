<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadAlumnosDePrimariaPorDocente
 *
...
class SociedadAlumnosDePrimariaPorDocente extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos de Primaria por Docente en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-07-01', 'valor' => '26.9000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
