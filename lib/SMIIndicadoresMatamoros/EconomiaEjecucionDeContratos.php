<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros EconomiaEjecucionDeContratos
 *
...
class EconomiaEjecucionDeContratos extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Ejecución de Contratos en Matamoros';
        ...
        $this->claves      = 'IMPLAN, Matamoros, Empresas, Doing Business, Índice de Competitividad Urbana';
        // Para el Organizador
