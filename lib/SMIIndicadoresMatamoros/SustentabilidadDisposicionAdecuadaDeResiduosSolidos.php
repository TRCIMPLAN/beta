<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SustentabilidadDisposicionAdecuadaDeResiduosSolidos
 *
...
class SustentabilidadDisposicionAdecuadaDeResiduosSolidos extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Disposición Adecuada de Residuos Sólidos en Matamoros';
