<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadDiscapacidad
 *
...
class SociedadDiscapacidad extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Discapacidad en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '4.4000', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda', 'notas' => 'Personas que tienen dificultad para el desempeño y/o realización de tareas en la vida cotidiana.'));
    } // datos
