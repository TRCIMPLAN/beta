<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadEspaciosCulturalesSegunImco
 *
...
class SociedadEspaciosCulturalesSegunImco extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Espacios Culturales (según IMCO) en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '0.0100', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '0.0100', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '0.0100', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '0.0100', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '0.1100', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
