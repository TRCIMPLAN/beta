<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadAlumnosConHabilidadesCientificasMatematicasBasicas
 *
...
class SociedadAlumnosConHabilidadesCientificasMatematicasBasicas extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Básicas en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '17.1000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
