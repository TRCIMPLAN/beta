<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SeguridadMontoReportadoEnRoboDeMercancias
 *
...
class SeguridadMontoReportadoEnRoboDeMercancias extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Monto Reportado en Robo de Mercancías en Matamoros';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2009-12-31', 'valor' => '0.10', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '0.31', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '0.00', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '0.01', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
