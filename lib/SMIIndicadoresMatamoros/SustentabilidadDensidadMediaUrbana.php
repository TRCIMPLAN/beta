<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SustentabilidadDensidadMediaUrbana
 *
...
class SustentabilidadDensidadMediaUrbana extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Densidad Media Urbana en Matamoros';
        ...
        $this->claves      = 'IMPLAN, Matamoros, Población, Infraestructura';
        // Para el Organizador
