<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadAlumnosDePreescolarPorDocente
 *
...
class SociedadAlumnosDePreescolarPorDocente extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos de Preescolar por Docente en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-07-01', 'valor' => '25.1000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
