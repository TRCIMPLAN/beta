<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadPersonasPorDebajoDeLaLineaDeBienestar
 *
...
class SociedadPersonasPorDebajoDeLaLineaDeBienestar extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personas por Debajo de la Línea de Bienestar en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '4.4800', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '3.9500', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '10.2400', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '2.3200', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '6.0700', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
