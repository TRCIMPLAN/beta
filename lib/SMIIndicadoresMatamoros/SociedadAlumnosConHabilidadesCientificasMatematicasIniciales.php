<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadAlumnosConHabilidadesCientificasMatematicasIniciales
 *
 ...
 */
class SociedadAlumnosConHabilidadesCientificasMatematicasIniciales extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Iniciales en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '65.9000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
