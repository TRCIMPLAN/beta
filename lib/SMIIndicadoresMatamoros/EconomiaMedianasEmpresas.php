<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros EconomiaMedianasEmpresas
 *
...
class EconomiaMedianasEmpresas extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '3.0100', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)', 'notas' => ''),
            array('fecha' => '2014-07-31', 'valor' => '1.7300', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)', 'notas' => ''));
    } // datos
