<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SustentabilidadIndiceDeGestionDeCalidadDelAire
 *
...
class SustentabilidadIndiceDeGestionDeCalidadDelAire extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Gestión de Calidad del Aire en Matamoros';
