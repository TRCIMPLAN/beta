<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros EconomiaProductividadLaboral
 *
...
class EconomiaProductividadLaboral extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Matamoros, Macroeconomía, Empleo';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '45744.00', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
