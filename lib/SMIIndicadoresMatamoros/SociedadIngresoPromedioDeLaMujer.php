<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadIngresoPromedioDeLaMujer
 *
...
class SociedadIngresoPromedioDeLaMujer extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Ingreso Promedio de la Mujer en Matamoros';
        ...
        $this->claves      = 'IMPLAN, Matamoros, Índice de Competitividad Urbana, Género, Empleo';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '1.0000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '0.9000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '0.9000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '0.9000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '1.0000', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
