<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SociedadAlumnosConPerfilCientificoMatematico
 *
...
class SociedadAlumnosConPerfilCientificoMatematico extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Perfil Científico-Matemático en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '42.0000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
