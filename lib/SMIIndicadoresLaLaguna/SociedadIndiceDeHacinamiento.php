<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SociedadIndiceDeHacinamiento
 *
...
class SociedadIndiceDeHacinamiento extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, La Laguna, Bienestar, Vivienda';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-06-25', 'valor' => '1.0600', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda', 'notas' => ''));
    } // datos
