<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna EconomiaGrandesEmpresasSegunCnnExpansion
 *
...
class EconomiaGrandesEmpresasSegunCnnExpansion extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Grandes Empresas (según CNN Expansión) en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '0.1592', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2009-12-31', 'valor' => '0.1611', 'fuente_nombre' => 'IMCO'),
