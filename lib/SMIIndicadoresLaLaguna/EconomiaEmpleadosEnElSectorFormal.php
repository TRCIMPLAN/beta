<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna EconomiaEmpleadosEnElSectorFormal
 *
...
class EconomiaEmpleadosEnElSectorFormal extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Empleados en el Sector Formal en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '70.0486', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '70.1246', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '57.2976', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '55.2093', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '48.7339', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
