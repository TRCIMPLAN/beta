<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna EconomiaCreditoALasEmpresas
 *
...
class EconomiaCreditoALasEmpresas extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Crédito a las Empresas en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '789.75', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '831.11', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '907.31', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '773.14', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '725.64', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
