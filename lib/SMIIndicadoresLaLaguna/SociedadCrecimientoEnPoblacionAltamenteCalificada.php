<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SociedadCrecimientoEnPoblacionAltamenteCalificada
 *
...
class SociedadCrecimientoEnPoblacionAltamenteCalificada extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Crecimiento en Población Altamente Calificada en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '-1.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '-1.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '-1.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '-1.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '-1.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
