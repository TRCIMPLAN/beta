<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna EconomiaCrecimientoDelSalarioPromedio
 *
...
class EconomiaCrecimientoDelSalarioPromedio extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, La Laguna, Índice de Competitividad Urbana, Mercados, Empleo';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '-3.6700', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '-3.6700', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '-3.6700', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '-3.6700', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '-3.6700', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
