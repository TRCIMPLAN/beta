<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna EconomiaEmpresasCertificadasConIso9000Y14000
 *
...
class EconomiaEmpresasCertificadasConIso9000Y14000 extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Empresas Certificadas con ISO-9000 y 14000 en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '11.6224', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '13.3688', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '16.1812', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '18.1313', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '21.4807', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
