<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna EconomiaProductividadLaboral
 *
...
class EconomiaProductividadLaboral extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, La Laguna, Macroeconomía, Empleo';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '421204.00', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
