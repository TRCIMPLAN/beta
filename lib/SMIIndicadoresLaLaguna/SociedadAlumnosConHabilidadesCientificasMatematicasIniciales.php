<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SociedadAlumnosConHabilidadesCientificasMatematicasIniciales
 *
...
class SociedadAlumnosConHabilidadesCientificasMatematicasIniciales extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Iniciales en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '58.8000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
