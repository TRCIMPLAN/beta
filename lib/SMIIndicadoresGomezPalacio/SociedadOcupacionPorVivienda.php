<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadOcupacionPorVivienda
 *
 ...
 */
class SociedadOcupacionPorVivienda extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Ocupación por Vivienda en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '3.9000', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda', 'notas' => ''));
    } // datos
