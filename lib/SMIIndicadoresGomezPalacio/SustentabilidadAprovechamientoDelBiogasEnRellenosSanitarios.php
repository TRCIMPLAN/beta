<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SustentabilidadAprovechamientoDelBiogasEnRellenosSanitarios
 *
...
/**
 * Clase SustentabilidadAprovechamientoDelBiogasEnRellenosSanitarios
 */
class SustentabilidadAprovechamientoDelBiogasEnRellenosSanitarios extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Aprovechamiento del Biogás en Rellenos Sanitarios en Gómez Palacio';
