<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadMortalidadInfantil
 *
...
class SociedadMortalidadInfantil extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Salud, Objetivos del Milenio, Índice de Competitividad Urbana';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2009-12-31', 'valor' => '5.9000', 'fuente_nombre' => 'SINAIS (SSA)', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '8.0000', 'fuente_nombre' => 'SINAIS (SSA)', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '12.6000', 'fuente_nombre' => 'SINAIS (SSA)', 'notas' => ''),
            ...
            array('fecha' => '2013-12-31', 'valor' => '9.1000', 'fuente_nombre' => 'SINAIS (SSA)', 'notas' => ''));
    } // datos
