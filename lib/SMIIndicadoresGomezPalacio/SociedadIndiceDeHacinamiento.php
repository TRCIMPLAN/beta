<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadIndiceDeHacinamiento
 *
...
class SociedadIndiceDeHacinamiento extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Bienestar, Vivienda';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-06-25', 'valor' => '0.9700', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda', 'notas' => ''));
    } // datos
