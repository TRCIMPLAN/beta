<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero
 *
...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Género, Educación, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '-0.2000', 'fuente_nombre' => 'INEGI', 'notas' => ''));
    } // datos
