<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SustentabilidadDesastresNaturales
 *
...
class SustentabilidadDesastresNaturales extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Desastres Naturales en Gómez Palacio';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2011-12-31', 'valor' => '4', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '5', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
