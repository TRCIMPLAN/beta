<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadAlumnosConHabilidadesCientificasMatematicasPracticas
 *
...
class SociedadAlumnosConHabilidadesCientificasMatematicasPracticas extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Prácticas en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '12.8000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
