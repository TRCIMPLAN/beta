<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadCrecimientoEnAccesoAServiciosDeSalud
 *
...
class SociedadCrecimientoEnAccesoAServiciosDeSalud extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Índice de Competitividad Urbana, Salud, Bienestar';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '-4.6000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '-4.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '-4.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '-4.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '-4.5500', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
