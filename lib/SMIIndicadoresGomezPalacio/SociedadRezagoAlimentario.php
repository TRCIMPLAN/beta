<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadRezagoAlimentario
 *
...
class SociedadRezagoAlimentario extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Grupos Vulnerables, Bienestar';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '18.1100', 'fuente_nombre' => 'CONEVAL', 'notas' => ''));
    } // datos
