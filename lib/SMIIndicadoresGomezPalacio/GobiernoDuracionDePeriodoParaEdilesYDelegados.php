<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio GobiernoDuracionDePeriodoParaEdilesYDelegados
 *
...
class GobiernoDuracionDePeriodoParaEdilesYDelegados extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Duración de Período para Ediles y Delegados en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '3.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2009-12-31', 'valor' => '3.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2010-12-31', 'valor' => '3.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2011-12-31', 'valor' => '3.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2012-12-31', 'valor' => '3.0000', 'fuente_nombre' => 'IMCO'));
    } // datos
