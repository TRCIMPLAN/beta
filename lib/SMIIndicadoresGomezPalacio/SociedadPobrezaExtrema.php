<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadPobrezaExtrema
 *
...
class SociedadPobrezaExtrema extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Bienestar, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '5.3000', 'fuente_nombre' => 'CONEVAL', 'notas' => ''));
    } // datos
