<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio GobiernoIndiceDeInformacionPresupuestal
 *
...
class GobiernoIndiceDeInformacionPresupuestal extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Índice de Competitividad Urbana, Transparencia';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '35.4839', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2009-12-31', 'valor' => '35.4839', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2010-12-31', 'valor' => '20.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2011-12-31', 'valor' => '32.2581', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2012-12-31', 'valor' => '23.5294', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2013-12-31', 'valor' => '35.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2014-12-31', 'valor' => '29.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2015-12-08', 'valor' => '30.0000', 'fuente_nombre' => 'IMCO'));
    } // datos
