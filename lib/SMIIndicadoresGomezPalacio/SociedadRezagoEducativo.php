<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadRezagoEducativo
 *
...
Tiene 16 años o más, nació a partir de 1982 y no cuenta con el nivel de educación obligatoria. CONEVAL';
        $this->claves      = 'IMPLAN, Gómez Palacio, Educación, Grupos Vulnerables, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '17.3100', 'fuente_nombre' => 'CONEVAL', 'notas' => ''));
    } // datos
