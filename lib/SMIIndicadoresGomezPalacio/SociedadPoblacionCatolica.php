<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadPoblacionCatolica
 *
 ...
 */
class SociedadPoblacionCatolica extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población Católica en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '82.8000', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda', 'notas' => ''));
    } // datos
