<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio GobiernoPeriodistasMuertosODesaparecidos
 *
...
class GobiernoPeriodistasMuertosODesaparecidos extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Periodistas Muertos o Desaparecidos en Gómez Palacio';
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Índice de Competitividad Urbana, Gobierno, Delincuencia, Seguridad';
        // Para el Organizador
