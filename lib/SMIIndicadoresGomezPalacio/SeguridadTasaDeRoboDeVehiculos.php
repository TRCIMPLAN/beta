<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SeguridadTasaDeRoboDeVehiculos
 *
...
class SeguridadTasaDeRoboDeVehiculos extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Delincuencia, Seguridad, Índice de Competitividad Urbana';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2012-12-31', 'valor' => '7.5040', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
