<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadAccesoAInstitucionesDeSalud
 *
...
class SociedadAccesoAInstitucionesDeSalud extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Acceso a Instituciones de Salud en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '52.2000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '48.0000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '49.7000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '52.3000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '48.7000', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
