<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio EconomiaDemandantesDeConflictoLaboral
 *
...
class EconomiaDemandantesDeConflictoLaboral extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Demandantes de Conflicto Laboral en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '10.9171', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '11.7557', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '9.8695', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '9.8511', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '12.3553', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
