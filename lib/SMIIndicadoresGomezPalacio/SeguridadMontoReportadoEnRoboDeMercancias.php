<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SeguridadMontoReportadoEnRoboDeMercancias
 *
...
class SeguridadMontoReportadoEnRoboDeMercancias extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Monto Reportado en Robo de Mercancías en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '0.55', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '0.79', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '0.46', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '0.29', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '0.16', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
