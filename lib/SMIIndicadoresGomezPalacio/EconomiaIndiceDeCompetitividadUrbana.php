<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio EconomiaIndiceDeCompetitividadUrbana
 *
...
class EconomiaIndiceDeCompetitividadUrbana extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Competitividad Urbana en Gómez Palacio';
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Competitividad';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2012-12-31', 'valor' => '42.5700', 'fuente_nombre' => 'IMCO', 'notas' => 'Ese valor equivale al lugar 59 de 77 ciudades, de acuerdo a la edición 2012 del ICU.'));
    } // datos
