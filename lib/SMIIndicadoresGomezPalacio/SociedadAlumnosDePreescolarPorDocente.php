<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadAlumnosDePreescolarPorDocente
 *
...
class SociedadAlumnosDePreescolarPorDocente extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos de Preescolar por Docente en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-07-01', 'valor' => '22.9000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
