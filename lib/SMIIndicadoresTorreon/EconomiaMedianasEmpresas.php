<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon EconomiaMedianasEmpresas
 *
...
class EconomiaMedianasEmpresas extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '2.1400', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)', 'notas' => ''),
            array('fecha' => '2014-07-31', 'valor' => '1.5700', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)', 'notas' => ''));
    } // datos
