<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon EconomiaOcupacionHotelera
 *
...
class EconomiaOcupacionHotelera extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Ocupación Hotelera en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '52.9100', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '44.3400', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '42.2400', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '42.2700', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '47.0100', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
