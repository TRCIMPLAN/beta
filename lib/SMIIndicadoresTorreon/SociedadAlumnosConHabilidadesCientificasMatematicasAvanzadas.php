<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadAlumnosConHabilidadesCientificasMatematicasAvanzadas
 *
...
class SociedadAlumnosConHabilidadesCientificasMatematicasAvanzadas extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Avanzadas en Torreón';
