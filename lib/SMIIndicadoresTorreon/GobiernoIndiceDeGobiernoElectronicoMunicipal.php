<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon GobiernoIndiceDeGobiernoElectronicoMunicipal
 *
...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Gobierno Electrónico Municipal en Torreón';
        ...
        $this->claves      = 'IMPLAN, Torreón, Gobierno Digital';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2011-12-31', 'valor' => '0.6916', 'fuente_nombre' => 'CIDE', 'notas' => ''));
    } // datos
