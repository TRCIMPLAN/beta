<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SeguridadPersonasInvolucradasEnDelitosDelFueroComun
 *
 ...
 */
class SeguridadPersonasInvolucradasEnDelitosDelFueroComun extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personas Involucradas en Delitos del Fuero Común en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2012-12-31', 'valor' => 'X', 'fuente_nombre' => 'INEGI'));
    } // datos
    ...
    public function otras_regiones() {
        return array(
            array('region_nombre' => 'Torreón', 'fecha' => '2012-12-31', 'valor' => 'X', 'fuente_nombre' => 'INEGI'),
