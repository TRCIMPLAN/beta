<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadVisitasAMuseosInah
 *
...
class SociedadVisitasAMuseosInah extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Visitas a Museos INAH en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '162.6932', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2009-12-31', 'valor' => '160.3001', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2010-12-31', 'valor' => '160.8459', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2011-12-31', 'valor' => '158.5143', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2012-12-31', 'valor' => '172.0800', 'fuente_nombre' => 'IMCO'));
    } // datos
    ...
    public function otras_regiones() {
        return array(
            array('region_nombre' => 'Torreón', 'fecha' => '2012-12-31', 'valor' => '172.0800', 'fuente_nombre' => 'IMCO'),
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2012-12-31', 'valor' => '90.4452', 'fuente_nombre' => 'IMCO'));
    } // otras_regiones
