...
class SociedadMortalidadInfantil extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function datos() {
        return array(
            array('fecha' => '2009-12-31', 'valor' => '6.1000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2010-12-31', 'valor' => '8.9000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2011-12-31', 'valor' => '6.7000', 'fuente_nombre' => 'SINAIS (SSA)'),
            ...
            array('fecha' => '2013-12-31', 'valor' => '12.4000', 'fuente_nombre' => 'SINAIS (SSA)'));
    } // datos
