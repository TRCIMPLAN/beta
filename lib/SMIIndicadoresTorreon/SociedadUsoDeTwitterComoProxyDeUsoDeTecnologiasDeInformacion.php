<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadUsoDeTwitterComoProxyDeUsoDeTecnologiasDeInformacion
 *
...
class SociedadUsoDeTwitterComoProxyDeUsoDeTecnologiasDeInformacion extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Uso de Twitter como Proxy de Uso de Tecnologías de Información en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '4.3230', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '4.3230', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '4.3230', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '4.3230', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '8.2249', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
