<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon EconomiaSectoresQueHanPresentadoAltoCrecimiento
 *
...
class EconomiaSectoresQueHanPresentadoAltoCrecimiento extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Sectores que Han Presentado Alto Crecimiento en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '3.0900', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2008-12-31', 'valor' => '15.9200', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '9.8800', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '11.9000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '11.4700', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '11.6800', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
