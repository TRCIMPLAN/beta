<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadDesastresNaturales
 *
...
class SustentabilidadDesastresNaturales extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Desastres Naturales en Torreón';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2011-12-31', 'valor' => '3', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '3', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
