<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon GobiernoParticipacionCiudadana
 *
...
class GobiernoParticipacionCiudadana extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Torreón, Índice de Competitividad Urbana, Participación Ciudadana';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '48.2900', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '48.2900', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '48.2900', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '64.6600', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '64.6600', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
