<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadEspaciosCulturales
 *
...
class SociedadEspaciosCulturales extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Torreón, Educación, Cultura';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-03-31', 'valor' => '16', 'fuente_nombre' => 'CONACULTA-IMPLAN', 'notas' => ''));
    } // datos
