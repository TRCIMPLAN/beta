...
class GobiernoCompetenciaElectoral extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '30.7700', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2008-12-31', 'valor' => '30.7700', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2009-12-31', 'valor' => '30.7700', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2009-12-31', 'valor' => '30.7700', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2010-12-31', 'valor' => '30.7700', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2010-12-31', 'valor' => '30.7700', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2011-12-31', 'valor' => '6.4100', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2011-12-31', 'valor' => '6.4100', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2012-12-31', 'valor' => '6.4100', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2012-12-31', 'valor' => '6.4100', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2013-07-07', 'valor' => '1.7700', 'fuente_nombre' => 'INE-IEPCC'));
    } // datos
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2013-07-07', 'valor' => '6.7000', 'fuente_nombre' => 'INE-IEPCC'));
    } // otras_regiones
