<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon GobiernoCompetenciaElectoralDiferenciaDeVotos
 *
...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Competencia Electoral Diferencia de Votos en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2012-07-01', 'valor' => '4367', 'fuente_nombre' => 'INE-IEPCC', 'notas' => ''));
    } // datos
