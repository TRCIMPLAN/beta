<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadDensidadMediaUrbana
 *
...
class SustentabilidadDensidadMediaUrbana extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Densidad Media Urbana en Torreón';
        ...
        $this->claves      = 'IMPLAN, Torreón, Población, Infraestructura';
        // Para el Organizador
