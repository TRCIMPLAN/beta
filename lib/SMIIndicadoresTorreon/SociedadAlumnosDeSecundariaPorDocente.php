<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadAlumnosDeSecundariaPorDocente
 *
...
class SociedadAlumnosDeSecundariaPorDocente extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos de Secundaria por Docente en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-07-01', 'valor' => '12.7000', 'fuente_nombre' => 'SEP', 'notas' => ''));
    } // datos
