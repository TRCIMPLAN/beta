<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadEmergenciasAmbientales
 *
...
class SustentabilidadEmergenciasAmbientales extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Emergencias Ambientales en Torreón';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2011-12-31', 'valor' => '5', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '4', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
