<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadEmpresasCertificadasComoLimpias
 *
...
class SustentabilidadEmpresasCertificadasComoLimpias extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Empresas Certificadas como Limpias en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '0.6000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '0.8000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '1.2000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
