<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SeguridadTasaDeHomicidios
 *
...
Las tasas de elaboración propia consideran las defunciones por homicidio ocurridas en el municipio de acuerdo a los registros administrativos de INEGI.';
        $this->claves      = 'IMPLAN, Lerdo, Seguridad, Delincuencia, Índice de Competitividad Urbana';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '15.6831', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '49.9219', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '63.1099', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '34.8924', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '41.8962', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
