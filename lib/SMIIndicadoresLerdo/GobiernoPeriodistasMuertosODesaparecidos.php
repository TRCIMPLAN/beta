<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo GobiernoPeriodistasMuertosODesaparecidos
 *
...
class GobiernoPeriodistasMuertosODesaparecidos extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Periodistas Muertos o Desaparecidos en Lerdo';
        ...
        $this->claves      = 'IMPLAN, Lerdo, Índice de Competitividad Urbana, Gobierno, Delincuencia, Seguridad';
        // Para el Organizador
