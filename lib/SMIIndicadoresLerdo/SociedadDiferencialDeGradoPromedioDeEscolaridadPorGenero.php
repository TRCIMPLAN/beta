<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero
 *
...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Lerdo, Género, Educación, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '-0.0600', 'fuente_nombre' => 'INEGI', 'notas' => ''));
    } // datos
