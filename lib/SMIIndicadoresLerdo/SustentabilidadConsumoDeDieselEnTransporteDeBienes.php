<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SustentabilidadConsumoDeDieselEnTransporteDeBienes
 *
...
class SustentabilidadConsumoDeDieselEnTransporteDeBienes extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Consumo de Diesel en Transporte de Bienes en Lerdo';
