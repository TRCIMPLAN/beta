<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadAlumnosConHabilidadesCientificasMatematicasBasicas
 *
...
class SociedadAlumnosConHabilidadesCientificasMatematicasBasicas extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Básicas en Lerdo';
