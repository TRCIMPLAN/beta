<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaSectoresQueHanFrenadoElCrecimiento
 *
...
class EconomiaSectoresQueHanFrenadoElCrecimiento extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Sectores que Han Frenado el Crecimiento en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '40.9700', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI', 'notas' => ''));
    } // datos
