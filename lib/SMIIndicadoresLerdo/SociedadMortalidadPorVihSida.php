<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadMortalidadPorVihSida
 *
...
class SociedadMortalidadPorVihSida extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad por VIH-SIDA en Lerdo';
        ...
        $this->claves      = 'IMPLAN, Lerdo, Salud, Bienestar, Grupos Vulnerables, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '3.3000', 'fuente_nombre' => 'SINAIS (SSA)', 'notas' => ''));
    } // datos
