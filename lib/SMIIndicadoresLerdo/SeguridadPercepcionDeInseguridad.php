<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SeguridadPercepcionDeInseguridad
 *
...
class SeguridadPercepcionDeInseguridad extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Percepción de Inseguridad en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '81.7400', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '81.7400', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '81.7400', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '73.3900', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '65.9700', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
