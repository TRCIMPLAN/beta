<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadRezagoEducativo
 *
...
Tiene 16 años o más, nació a partir de 1982 y no cuenta con el nivel de educación obligatoria. CONEVAL';
        $this->claves      = 'IMPLAN, Lerdo, Educación, Grupos Vulnerables, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '16.7600', 'fuente_nombre' => 'CONEVAL', 'notas' => ''));
    } // datos
