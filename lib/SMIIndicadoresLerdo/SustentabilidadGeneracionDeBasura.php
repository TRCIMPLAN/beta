<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SustentabilidadGeneracionDeBasura
 *
...
class SustentabilidadGeneracionDeBasura extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Generación de Basura en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '7.8000', 'fuente_nombre' => 'INEGI', 'notas' => ''));
    } // datos
