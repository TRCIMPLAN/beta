<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadAccesoAInstitucionesDeSalud
 *
...
class SociedadAccesoAInstitucionesDeSalud extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Acceso a Instituciones de Salud en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '41.4000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '50.1000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '59.9000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '26.4000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '31.9000', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
