<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaRegistroDeUnaPropiedadPercentilPromedio
 *
...
class EconomiaRegistroDeUnaPropiedadPercentilPromedio extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Registro de una Propiedad (percentil promedio) en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '0.5800', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '0.7953', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '0.7953', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '0.7953', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '0.7953', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
