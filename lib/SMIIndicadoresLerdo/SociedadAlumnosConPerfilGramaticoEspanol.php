<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadAlumnosConPerfilGramaticoEspanol
 *
...
class SociedadAlumnosConPerfilGramaticoEspanol extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Perfil Gramático-Español en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '37.0000', 'fuente_nombre' => 'SEP'));
    } // datos
