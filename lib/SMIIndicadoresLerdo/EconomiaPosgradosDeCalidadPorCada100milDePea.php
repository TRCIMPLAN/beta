<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaPosgradosDeCalidadPorCada100milDePea
 *
...
class EconomiaPosgradosDeCalidadPorCada100milDePea extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Posgrados de Calidad (por cada 100mil de PEA) en Lerdo';
        ...
        $this->claves      = 'IMPLAN, Lerdo, Índice de Competitividad Urbana, Educación, Innovación';
        // Para el Organizador
