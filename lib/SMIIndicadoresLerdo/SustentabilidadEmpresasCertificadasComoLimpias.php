<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SustentabilidadEmpresasCertificadasComoLimpias
 *
...
class SustentabilidadEmpresasCertificadasComoLimpias extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Empresas Certificadas como Limpias en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '0.2000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2009-12-31', 'valor' => '2.8000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2010-12-31', 'valor' => '1.4000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2011-12-31', 'valor' => '5.8000', 'fuente_nombre' => 'IMCO', 'notas' => ''),
            array('fecha' => '2012-12-31', 'valor' => '1.4000', 'fuente_nombre' => 'IMCO', 'notas' => ''));
    } // datos
