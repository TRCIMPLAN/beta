<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaPequenasEmpresas
 *
...
class EconomiaPequenasEmpresas extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '6.9600', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)', 'notas' => ''),
            array('fecha' => '2014-07-31', 'valor' => '5.6200', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)', 'notas' => ''));
    } // datos
