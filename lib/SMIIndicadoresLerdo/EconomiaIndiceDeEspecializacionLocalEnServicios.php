<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaIndiceDeEspecializacionLocalEnServicios
 *
...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \SMIBaseNUEVO\PublicacionWeb {
    ...
    public function datos() {
        return array(
            array('fecha' => '1998-12-31', 'valor' => '17.2300', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI', 'notas' => ''),
            array('fecha' => '2003-12-31', 'valor' => '6.3000', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI', 'notas' => ''),
            array('fecha' => '2008-12-31', 'valor' => '8.5600', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI', 'notas' => ''),
            array('fecha' => '2013-12-31', 'valor' => '9.3554', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI', 'notas' => ''));
    } // datos
