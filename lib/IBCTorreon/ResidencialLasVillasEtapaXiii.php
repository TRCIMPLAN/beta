...
/**
 * Clase ResidencialLasVillasEtapaXiii
 */
class ResidencialLasVillasEtapaXiii extends \IBCBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre          = 'Residencial Las Villas Etapa Xiii';
        $this->autor           = 'IMPLAN Torreón Staff';
        $this->fecha           = '2016-09-14 08:25:21';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes
        $this->archivo         = 'residencial-las-villas-etapa-xiii';
        $this->imagen          = '../imagenes/imagen.jpg';
        $this->imagen_previa   = '../imagenes/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion     = 'Colonia Residencial Las Villas Etapa Xiii de IBC Torreón.';
    ...
    public function datos() {
        return array(
            'Demografía' => array(
                'Población total' => '5',
                'Porcentaje de población masculina' => '40.00',
                'Porcentaje de población femenina' => '60.00',
