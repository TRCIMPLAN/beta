...
/**
 * Clase ResidencialLasVillasEtapaXii
 */
class ResidencialLasVillasEtapaXii extends \IBCBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre          = 'Residencial Las Villas Etapa Xii';
        $this->autor           = 'IMPLAN Torreón Staff';
        $this->fecha           = '2016-09-02 12:55:35';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes
        $this->archivo         = 'residencial-las-villas-etapa-xii';
        $this->imagen          = '../imagenes/imagen.jpg';
        $this->imagen_previa   = '../imagenes/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion     = 'Colonia Residencial Las Villas Etapa Xii de IBC Torreón.';
    ...
    public function datos() {
        return array(
            ...
            'Viviendas' => array(
                ...
                'Ocupación por Vivienda' => '7.00',
                'Viviendas con Electricidad' => '100.00',
                'Viviendas con Agua' => '100.00',
                'Viviendas con Drenaje' => '100.00',
                'Viviendas con Televisión' => '100.00',
                'Viviendas con Automóvil' => '100.00',
                'Viviendas con Computadora' => '82.20',
                'Viviendas con Celular' => '100.00',
                'Viviendas con Internet' => '57.30'
            ),
